...
Lightning Tag will automatically execute any data collection rules that you have configured in cooperation with your Lotame account representative. In addition, you can explicitly pass in data to attribute to the user by supplying it in the data object of your tag input.
